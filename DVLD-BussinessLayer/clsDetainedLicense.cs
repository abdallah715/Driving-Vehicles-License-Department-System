...
namespace DVLD_BussinessLayer
{
    public class clsDetainedLicense
    {
        ...
        // As for the release you must make an Application to pay fees to release it 
        ...
        public bool ReleaseDetainedLicense(int ReleasedByUserID, ref int ApplicationID)
        {
            ...
            Application.ApplicantPersonID = this.CreatedByUserInfo.PersonID;
            Application.ApplicationDate = DateTime.Now;
            Application.ApplicationTypeID = (int)clsApplication.enApplicationType.ReleaseDetainedDrvingLicense;
            Application.AppStatus = (byte)clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationType.Find((int)clsApplication.enApplicationType.ReleaseDetainedDrvingLicense).ApplicationFees;
            ...
            this.ReleasedByUserID = ReleasedByUserID;
            return this.ReleaseDetainedLicense(ReleasedByUserID, Application.ApplicationID);
