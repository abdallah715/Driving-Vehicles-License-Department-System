...
namespace DVLD_BussinessLayer
{
    public class clsInternationalLicense : clsApplication
    {
...

        {
            ...
            this.ApplicationTypeID = (int)clsApplication.enApplicationType.NewInternaltionalLicense;
...

        {
            ...
            base.ApplicationTypeID = (int)clsApplication.enApplicationType.NewInternaltionalLicense;
        ...
        public static bool IsThereActiveLicenseByLicenseID(int licenseID)
        {
            return clsInternationalLicenseData.IsThereActiveLicenseByLicenseID(licenseID);
        }
