...
namespace DVLD_DataAccessLayer
{
    public class clsLocalDrivingLicenseApplicationData
    {
        ...
        public static bool GetLDLicenseApplicationInfoByID(int ID, ref int ApplicationID, ref int LicenseClassID)
        {
            bool isFound = false;
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
        ...
        public static byte GetPassedTestByLDApplicationID(int lDApplicationID)
        {
            ...
            string query = "select PassedTestCount from LocalDrivingLicenseApplications_View\r\nwhere LocalDrivingLicenseApplicationID = @lDApplicationID";

            SqlCommand command = new SqlCommand(query, connection);

            command.Parameters.AddWithValue("@lDApplicationID", lDApplicationID);
            try
            {
                connection.Open();
                object result = command.ExecuteScalar();
